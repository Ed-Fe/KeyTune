...
class PluginAPI:
    ...
    def resolve_media(self, media_path: str) -> dict[str, Any]:
        """Resolve a playable URL through KeyTune's configured yt-dlp runtime."""
        self.require(PluginPermission.YT_DLP)
        return self._bridge.invoke("yt_dlp.resolve", {"media_path": media_path})
    ...
    def analyze_media(self, media_path: str) -> dict[str, Any]:
        ...
        return self._bridge.invoke("autodj.analyze", {"media_path": media_path})
