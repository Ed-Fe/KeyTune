...
class PluginHostAdapter:
    ...
    def _yt_dlp_resolve(self, arguments, _manifest):
        resolved = self._youtube_service().resolve_stream_playback(str(arguments.get("media_path", "")))
    ...
    def _yt_dlp_info(self, arguments, _manifest):
        ...
        authentication = load_saved_playback_auth()
        response = extract_info(
            str(arguments.get("media_path", "")),
            cookie_file_path=authentication.cookie_file_path,
            http_headers=authentication.yt_dlp_http_headers,
    ...
    def _autodj_analyze(self, arguments, _manifest):
        ...
        return service.analyze(str(arguments.get("media_path", "")))
